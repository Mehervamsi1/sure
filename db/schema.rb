...
ActiveRecord::Schema[8.1].define(version: 2026_07_28_090000) do
  ...
  create_table "expense_containers", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "color"
    t.datetime "created_at", null: false
    t.string "currency", null: false
    t.text "description"
    ...
    t.datetime "updated_at", null: false
    t.index ["family_id", "name"], name: "index_expense_containers_on_family_id_and_name", unique: true
    t.index ["family_id", "status"], name: "index_expense_containers_on_family_id_and_status"
    t.index ["family_id"], name: "index_expense_containers_on_family_id"
  end
  ...
  create_table "transactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["expense_container_id"], name: "index_transactions_on_expense_container_id"
  ...
  add_foreign_key "expense_containers", "families"
  ...
  add_foreign_key "transactions", "expense_containers"
