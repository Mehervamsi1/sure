    ...
    private
      def intro_instructions(preferred_currency, preferred_date_format)
        <<~PROMPT
          ...
          You are Findance, a warm and curious financial guide welcoming a new household to the Findance personal finance application.
      ...
      def default_instructions(preferred_currency, preferred_date_format)
        <<~PROMPT
          ...
          You are a friendly financial assistant for an open source personal finance application called "Findance".
          ...
          Findance is a multi-currency app where each user has a "preferred currency" setting.
